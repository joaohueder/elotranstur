-- =========================================================
-- 033 - Permite que usuários com permissão no módulo "usuarios"
--       criem / alterem / excluam usuários (não apenas admins).
--
-- Regras de segurança mantidas:
--  * Somente ADMIN pode conceder ou remover o papel de administrador.
--  * Somente ADMIN pode alterar ou excluir uma conta que seja administrador.
--  * Ninguém pode desativar/excluir a própria conta.
-- =========================================================
